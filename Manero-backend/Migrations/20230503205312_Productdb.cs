    ...
    public partial class Productdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductColors", x => new { x.ProductEntityId, x.ColorEntityId });
                    table.ForeignKey(
                        name: "FK_ProductColors_Colors_ColorEntityId",
                        column: x => x.ColorEntityId,
                        principalTable: "Colors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductColors_Products_ProductEntityId",
                        column: x => x.ProductEntityId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductSizes", x => new { x.ProductEntityId, x.SizeEntityId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ProductEntityId = table.Column<int>(type: "int", nullable: false),
                    TagsEntityId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTags", x => new { x.ProductEntityId, x.TagsEntityId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTags_Tags_TagsEntityId",
                        column: x => x.TagsEntityId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTypes", x => new { x.ProductEntityId, x.TypeEntityId });
                    table.ForeignKey(
                        name: "FK_ProductTypes_Products_ProductEntityId",
                        column: x => x.ProductEntityId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTypes_Types_TypeEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductColors_ColorEntityId",
                table: "ProductColors",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTags_TagsEntityId",
                table: "ProductTags",
                column: "TagsEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTypes_TypeEntityId",
                table: "ProductTypes",
                column: "TypeEntityId");
