...
{
    /// <inheritdoc />
    public partial class djuptestning : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AspNetUserCompanyAddresses",
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserCompanyAddresses", x => new { x.UserId, x.CompanyId });
                    table.ForeignKey(
                        name: "FK_AspNetUserCompanyAddresses_AspNetCompanies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "AspNetCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserCompanyAddresses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserCompanyAddresses_CompanyId",
                table: "AspNetUserCompanyAddresses",
                column: "CompanyId");
